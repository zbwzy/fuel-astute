...
module Astute
  class CobblerManager
    ...
    def reboot_nodes(nodes)
      Astute.logger.info "************** reboot_nodes ***********************"
      Astute.logger.info "============== nodes.size: #{nodes.size} =============="
      Astute.logger.info "============== Astute.config.iops: #{Astute.config.iops} =============="
      Astute.logger.info "============== Astute.config.splay_factor: #{Astute.config.splay_factor} =============="
      splay = calculate_splay_between_nodes(nodes)
      Astute.logger.info "============== splay: #{splay} =============="
