...
module Astute
  class NodesRemover
    ...
    def initialize(ctx, nodes, reboot=true)
      ...
      @reboot = reboot
      Astute.logger.info "************** nodes_remover.rb method initialize ***********************"      
      Astute.logger.info "============== @ctx: #{@ctx} =============="
      Astute.logger.info "============== @nodes: #{@nodes} =============="
      Astute.logger.info "============== @reboot: #{@reboot} =============="
    end

    def remove
      Astute.logger.info "************** nodes_remover.rb method remove ***********************" 
    ...
    def remove_nodes(nodes)
      Astute.logger.info "************** nodes_remover.rb method remove_nodes ***********************"	
      if nodes.empty?
