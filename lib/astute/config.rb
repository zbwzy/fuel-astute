...
module Astute
  ...
  def self.default_config
    ...
    # Library settings
    conf[:PUPPET_TIMEOUT] = 360 * 60       # maximum time it waits for the whole deployment
    conf[:PUPPET_DEPLOY_INTERVAL] = 10    # sleep for ## sec, then check puppet status again
    ...
    conf[:PROVISIONING_TIMEOUT] = 360 * 60 # timeout for booting target OS in provision
