...
module Astute
  class DeployActions
    ...
    def process
      Astute.logger.info "************** deploy_actions.rb class DeployActions method process ***********************"
      Astute.logger.info "============== actions: #{@actions} =============="
      @actions.each { |action| action.process(@deployment_info, @context) }
      Astute.logger.info "************** deploy_actions.rb class DeployActions method process actions run over***********************"
    end
  end
  ...
  class PreNodeActions
    ...
    def process(deployment_info)
      Astute.logger.info "************** deploy_actions.rb class PreNodeActions method process ***********************"
      ...
      Astute.logger.info "************** deploy_actions.rb class PreNodeActions method process actions run over***********************"
